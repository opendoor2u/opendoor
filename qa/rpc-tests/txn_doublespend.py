...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 OPENDOOR:
        ...
        # First: use raw transaction API to send 12400 OPENDOOR to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 OPENDOOR coin each
        ...
        # Node0's balance should be starting balance, plus 500OPENDOOR for another
        ...
        # Node0's total balance should be starting balance, plus 1000OPENDOOR for

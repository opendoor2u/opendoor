 ...
 *
 *   // network
 *   COpendoorNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.opendoor.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class COpendoorNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    COpendoorNetwork(UniValue objIn)
    {
...
// // can be under: OpendoorNetwork
// //   -- signature requirements : Key1(User)
// class COpendoorNetworkVariable : public CGovernanceObject
// {
// private:

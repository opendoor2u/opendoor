...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "OpendoorNetwork") type = OpendoorNetwork;
    if(strType == "OpendoorNetworkVariable") type = OpendoorNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == OpendoorNetwork) s = "OpendoorNetwork";
    if(type == OpendoorNetworkVariable) s = "OpendoorNetworkVariable";

...
*
*   Why is this needed?
*   - In Opendoor some blocks are superblocks, which output much higher amounts of coins
...
{
    if(fLiteMode) return; // disable all Opendoor specific functionality
...
bool CMasternodeBlockPayees::IsTransactionValid(const CTransaction& txNew)
{
    ...
    LogPrintf("CMasternodeBlockPayees::IsTransactionValid -- ERROR: Missing required payment, possible payees: '%s', amount: %f OPENDOOR\n", strPayeesPossible, (float)nMasternodePayment/COIN);
    return false;
}

    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Opendoor Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Opendoor Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  opendoor-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Opendoor in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 OPENDOOR, 0.1 OPENDOOR, 1 OPENDOOR and 10 OPENDOOR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://opendoorpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://opendoorpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Opendoor Core is shutting down...") + "<br /><br />" +

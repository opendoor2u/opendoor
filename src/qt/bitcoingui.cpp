    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Opendoor Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Opendoor address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and opendoor: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Opendoor Core"), this);
    aboutAction->setStatusTip(tr("Show information about Opendoor Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Opendoor Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Opendoor addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Opendoor addresses"));
    ...
    openAction->setStatusTip(tr("Open a opendoor: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Opendoor Core help message to get a list with possible Opendoor Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Opendoor Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Opendoor network", "", count));
    } else {
...
{
    QString strTitle = tr("Opendoor Core"); // default title

    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("OPENDOOR-light"), QVariant("light"));
    ui->theme->addItem(QString("OPENDOOR-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("OPENDOOR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("OPENDOOR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("OPENDOOR-traditional"), QVariant("trad"));

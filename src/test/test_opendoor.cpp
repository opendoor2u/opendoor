...
#define BOOST_TEST_MODULE Opendoor Test Suite

#include "test_opendoor.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_opendoor_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

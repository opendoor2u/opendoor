...
2. run opendoord with -printalert or -sendalert like this:
   /path/to/opendoord -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.opendoor.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Opendoor Core:0.12.0.58/"));

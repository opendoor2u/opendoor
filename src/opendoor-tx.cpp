...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Opendoor Core opendoor-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  opendoor-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded opendoor transaction") + "\n" +
              "  opendoor-tx [options] -create [commands]   " + _("Create hex-encoded opendoor transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded opendoor transaction

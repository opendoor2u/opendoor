...
This mechanism has been integrated into Bitcore-Node-Opendoor which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/opendoorpay/insight-api-opendoor#web-socket-api](https://github.com/opendoorpay/insight-api-opendoor#web-socket-api)
* API: [https://github.com/opendoorpay/insight-api-opendoor#instantsend-transactions](https://github.com/opendoorpay/insight-api-opendoor#instantsend-transactions)
...
By default, the Opendoor Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Opendoor Core daemon:

...
Opendoor Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Opendoor Core, where everyone uses
...
pay attention to for reviewers of Opendoor Core code.

General Opendoor Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Opendoor Core uses tinyformat, which is type safe. Leave them out to avoid confusion

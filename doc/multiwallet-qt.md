...
Only requiring some minor changes is opendoor.cpp.
...
Changes to opendoor.cpp
----------------------
opendoor.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
